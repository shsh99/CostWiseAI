...
export const roleInsights: Record<Role, RoleInsight> = {
  ...
  PM: {
    headline: '프로젝트 실행 관점에서 원가/성과 흐름을 점검합니다.',
    summary:
      '본부 포트폴리오와 상세 프로젝트를 함께 검토하며 실행 우선순위와 승인 흐름을 조정합니다.',
    decisionFocus: '프로젝트 우선순위, 배부 기준, 검토 요청',
    riskWatch:
      '핵심 지표를 동시에 보지 않으면 실행 우선순위가 왜곡될 수 있습니다.',
    nextAction: '검토 의견 정리 후 승인/보류 요청'
  },
  ACCOUNTANT: {
    headline: '원가 배부 근거와 평가 지표의 정합성을 집중 검증합니다.',
    summary:
      '원가/평가 데이터의 산식과 가정값을 비교해 검토 의견과 승인 근거를 명확히 남깁니다.',
    decisionFocus: '원가 배부 검증, 평가 지표 정합성, 검토 의견',
    riskWatch: '산식 근거가 누락되면 승인 판단의 신뢰도가 떨어질 수 있습니다.',
    nextAction: '원가/평가 검토 결과 기록'
  },
  AUDITOR: {
...
export const apiBaseUrl =
  ...
  'https://costwiseai-production.up.railway.app';
